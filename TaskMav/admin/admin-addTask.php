...
<html>
    ...
    <body>
        <main>
            <h2 class="title text-justify py-4">Add New Task</h2>
            <div class="container">
            ...
            <!-- add new project form-->
                <section class="glass-proj">
                        <form class="addproject-form" method="post" style=" width: 50vw; margin-left: 5vw; padding-top: 3vw;" role="form">
                        <div class="controls">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group text-left text-white font-weight-bold"> <label for="form_projectname">Assigned Project</label> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group text-left text-white font-weight-bold"> <label for="form_status">Status</label> 
                                        <select id="form_status" type="text" name="status" class="form-control" required="required" data-error="Status is required."> </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_tleader">Task</label> 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_descript">Description</label> 
                                            <textarea id="form_descript" name="description" class="form-control" placeholder="Write the description here." rows="4"></textarea> 
                                        </div>
                                    </div>
                                    <div class="ins_container">
                                        <center>
                                            <input class="btn1 btn-primary" type="submit" value="ADD" name="btnAddTask">
                                        </center>
                                     </div>
                                </div>
                            </div>
