...
if(isset($_POST["btnAddProject"])){
    ...
    if($projectName && $status && $startDate && $endDate && $tLeader && $department && $description){
        ...
        VALUES (NULL, '$projectName', '$description', '$status', '$startDate', '$endDate', '$department', '$teamLeader', NULL, NULL) ");

        echo "<script> window.location.href='admin-projectList.html'; </script>";
            ...
            <!-- add new project form-->
                <section class="glass-proj">
                        ...
                        <div class="controls">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group text-left text-white font-weight-bold"> <label for="form_tmembers">Department</label> <input id="form_tmembers" type="text" name="department" class="form-control" placeholder="Department">
                                            </select> </div>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="ins_container">
                             <div class="btn1"><input type="submit" value="Save" name="btnAddProject"></div>
                             <!--<input type="submit" name="" value="Save"></a>-->
                             <div class="btn1 cancel"><a href="#">Cancel </a></div>
