                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group text-left text-white font-weight-bold">
                                        ...
                                        <input id="form_projectname" type="text" name="firstName" class="form-control" placeholder="First Name" required="required" data-error="First Name is required."> 
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group text-left text-white font-weight-bold">
                                        <label for="form_name">Middle Name</label> 
                                        <input id="form_projectname" type="text" name="middleName" class="form-control" placeholder="Middle Name" required="required" data-error="Middle Name is required."> 
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group text-left text-white font-weight-bold">
                                        <label for="form_name">Last Name</label> 
                                        <input id="form_projectname" type="text" name="lastName" class="form-control" placeholder="Last Name" required="required" data-error="Last Name is required."> 
                                    </div>
                                </div>
                            </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_startdate">Email</label> 
                                            <input id="form_startdate" type="text" placeholder="Email" name="email" class="form-control"> 
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_enddate">Contact No.</label> 
                                            <input id="form_enddate" type="text" placeholder="Contact No." name="phoneNo" class="form-control"> 
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_tleader">Role</label> 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group text-left text-white font-weight-bold"> 
                                            <label for="form_descript">Address</label> 
                                            <textarea id="form_descript" name="address" class="form-control" placeholder="Write your address here." rows="4"></textarea> 
                                        </div>
                                    </div>
