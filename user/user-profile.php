                            ...
                            <div class="account-settings">
                              <div class="user-profile">
                                <div class="user-avatar">
                                  <a href="edit-image.php">	<img src="img/man.png" alt="Maxwell Admin"> </a>
                                </div>
                                  <h5 class="user-name">Juan Dela Cruz</h5>
                                  <h6 class="user-email">uip@melhamconstruction.ph</h6>
                              </div>
                              <center><a href="edit-user.php" class="btn btn-primary">Edit Profile</a></center>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row gutters">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="fullName" placeholder="Juan Dela Cruz" disabled>
                            </div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <label for="eMail">Email</label>
                              <input type="email" class="form-control" id="eMail" placeholder="uip.melhamconstruction.ph" disabled>
                            </div>
                          </div>
                          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                              <label for="phone">Contact Number</label>
                              <input type="text" class="form-control" id="phone" placeholder="0912-345-6789" disabled>
                            </div>
                          </div>
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                              <label for="address">Home Address</label>
                              <input type="text" class="form-control" id="address" placeholder="C. Padilla Street, Mambaling, Cebu City" disabled>
                            </div>
                          </div>
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="dept" placeholder="MCC-Project-IT-26" disabled>
                            </div>
                          </div>
                      </div>
                    </div>
