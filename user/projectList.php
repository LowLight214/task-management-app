        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                ...
                <div class="row">
                    <?php
                        $getProjects = mysqli_query($conn,"SELECT * FROM tbl_project WHERE departmentID=$departmentID");
                        $count = 0;

                        while($rowProject = mysqli_fetch_assoc($getProjects)){
                            $count++;

                            $db_projectName = $rowProject["projectTitle"];
                            $db_projectDesc = $rowProject["projectDescription"];
                            $db_projectProgress = $rowProject["projectProgress"];
                    ?>
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="card shadow mb-4 projects" style="width: 18rem;">
                            <img class="card-img-top" src="img/scene<?php echo $count; ?>.jpg" alt="Card image cap" style="width:286px;height:180px;">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $db_projectName; ?></h5>
                                <p class="card-text"><?php echo $db_projectDesc; ?></p>
                                        
                                <div class="progress">
                                    <div class="progress-bar" style="width:<?php echo $db_projectProgress; ?>%"></div>
                                </div>
